...
namespace gts
{
    public class mc_cfg
	{
			...
			[DllImport("gts.dll")]
			public static extern short GT_PrintWatch(short cardNum,out char pFileName,int start,uint printCount);
			[DllImport("gts.dll")]
			...
			[DllImport("gts.dll")]
			public static extern short GT_GetEventLoop(short cardNum,short eventIndex,out int pCount); 
			[DllImport("gts.dll")]
