...
namespace CommonDriver
{
    ...
    public class KeyenceMcNetDriver : IPLCDriver, IMultiReadWrite
    {
        ...
        private KeyenceMcNet mc = new KeyenceMcNet();
        public void Dispose()
        {
            mc.ConnectClose();
        ...
        public KeyenceMcNetDriver(IDataServer server, short id, string name)
        {
            ID = id;
            Name = name;
            Parent = server;
