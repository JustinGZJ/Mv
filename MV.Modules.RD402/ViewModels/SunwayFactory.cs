...
{
    public class SunwayFactory : IFactoryInfo
    {
        ...
        public SunwayFactory(IConfigureFile configure, IDeviceReadWriter device, IUnityContainer container)
        {
            this.configure = configure;
            this.device = device;
            this.snGetter = container.Resolve<IGetSn>("信维");
