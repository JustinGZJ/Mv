...
namespace MotionWrapper.Interface
{
    /// <summary>
    /// 捕获的参数
    /// </summary>
    public class CCapturePrm
    {
        ...
        public int index = 0;//硬件参数号
        public CCapturePrm(int _type, int _index)
        {
            type = _type;
            index = _index;
        }
    ...
    public interface IIoPart1
    {
        ...
        bool getDi(CIoMap input);
        bool getDo(CIoMap output);
        void setDO(CIoMap output, bool value);
    }
    /// <summary>
    /// 一些建议组件  都要初始化反初始化和刷新
    /// </summary>
